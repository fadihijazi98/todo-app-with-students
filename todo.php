...
$todoItems = [
    [
        ...
        "description" => "make my morning  coffee",
        "status" => "todo",
        "created_at" => "2023/02/14 07:13:25"
    ],
    [
        "title" => "Evening Coffee",
        "description" => "make my evening coffee",
        "status" => "todo",
        "created_at" => "2023/02/14 10:13:25"
    ],
    [
        "title" => "Foo",
        "description" => "bar",
        "status" => "todo",
        "created_at" => "2023/02/14 12:13:25"
    ],
];
    ...
    <div class="bg-gray-100 space-y-12 py-10 rounded-2xl">
        ...
        <div class="container flex justify-center gap-16">
            <div class="w-80 border-r border-r-2 pr-4 border-purple-500">
                <form action="todo_insert_action.php" method="post">
                    ...
                    <div class="mb-6">
                        ...
                        <!-- {$will send description value by key called 'description'} -->
            ...
            <div>
                <div class="w-80 mb-6">
                    <!-- {$loop start here} -->
                    <?php foreach ($todoItems as $index => $todoItem) { ?>
